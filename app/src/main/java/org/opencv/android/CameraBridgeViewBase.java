...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (modified != null) {
            try {
                // Bitmap object stored in native area from Android 8.0
                ...
                bmpValid = false;
                // 此处修改如果不对的话释放图片再重新根据大小进行创建
                // catch代码块中的代码可能不会执行，因为当native层报错，catch代码块可能捕获不到这个异常
//                if (mCacheBitmap != null) {
//                    mCacheBitmap.recycle();
...
//                canvas.rotate(90, 0, 0);
                ...
                if (scale != 0 && scale2 != 0) {
                    canvas.scale(scale2, scale2, 0, 0);
                }
    ...
    // 这个函数必须在SurfaceTexture的构造函数调用之前被调用
...
//        mCacheBitmap = Bitmap.createBitmap(mFrameHeight, mFrameWidth, Bitmap.Config.ARGB_8888);
     ...
     * <p>
     * 计算 从摄像头捕获到的 图像，最后选择一个合适大图片大小 展示到屏幕
     *
