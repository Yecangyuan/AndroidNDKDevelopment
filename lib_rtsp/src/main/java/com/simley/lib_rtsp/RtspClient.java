...
import com.simley.lib_rtsp.description.MediaDescription;
import com.simley.lib_rtsp.description.SessionDescription;
import com.simley.lib_rtsp.description.SessionDescriptionParser;
import com.simley.lib_rtsp.request.RtspRequest;
import com.simley.lib_rtsp.response.RtspDescribeResponse;
import com.simley.lib_rtsp.response.RtspOptionsResponse;
import com.simley.lib_rtsp.response.RtspPlayResponse;
import com.simley.lib_rtsp.response.RtspResponse;
import com.simley.lib_rtsp.response.RtspSetupResponse;
...
/* package */ final class RtspClient implements Closeable {
    ...
    @Nullable
    private RtspAuthUserInfo rtspAuthUserInfo;
    @Nullable
