package com.simley.lib_catcher.anr;
...
public class ANRWatchDog extends Thread {
    ...
    private static final ANRListener DEFAULT_ANR_LISTENER = error -> {
        throw error;
    };

    private static final ANRInterceptor DEFAULT_ANR_INTERCEPTOR = duration -> 0;

    private static final InterruptionListener DEFAULT_INTERRUPTION_LISTENER = exception -> Log.w("ANRWatchdog", "Interrupted: " + exception.getMessage());
