...
import com.simley.lib_socket.aysnc.AsyncSSLSocketWrapper;
...
import com.simley.lib_socket.aysnc.callback.ValueCallback;
    ...
    ListenCallback mListenCallback = new ListenCallback() {
        ...
        public void onAccepted(final AsyncSocket socket) {
            final AsyncHttpServerRequestImpl req = new AsyncHttpServerRequestImpl() {
                ...
                final Runnable onFinally = () -> Log.i("HTTP", "Done");

                final ValueCallback<Exception> onException = value -> Log.e("HTTP", "exception", value);
