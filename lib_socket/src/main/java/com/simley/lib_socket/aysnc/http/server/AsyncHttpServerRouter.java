...
import com.simley.lib_socket.aysnc.http.WebSocket;
import com.simley.lib_socket.aysnc.http.WebSocketImpl;
import com.simley.lib_socket.aysnc.http.method.AsyncHttpGet;
import com.simley.lib_socket.aysnc.http.method.AsyncHttpHead;
import com.simley.lib_socket.aysnc.http.method.AsyncHttpPost;
...
public class AsyncHttpServerRouter implements RouteMatcher {
        ...
        addAction(AsyncHttpGet.METHOD, regex, new HttpServerRequestCallback() {
            ...
            public void onRequest(AsyncHttpServerRequest request, final AsyncHttpServerResponse response) {
                ...
                if (file.isDirectory() && list) {
                    ...
                    Comparator<File> c = (lhs, rhs) -> lhs.getName().compareTo(rhs.getName());
    ...
    abstract static class AsyncHttpServerRequestImpl extends com.simley.lib_socket.aysnc.http.server.AsyncHttpServerRequestImpl {
        Matcher matcher;
